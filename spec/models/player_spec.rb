...
RSpec.describe Player, type: :model do
  ...
  it 'calculates rating correctly for a forward' do
    player = Player.create(name: 'Test Forward', role: 'forward', team:)
  ...
  it 'calculates rating correctly for a midfielder' do
    player = Player.create(name: 'Test Midfielder', role: 'midfielder', team:)
  ...
  it 'calculates rating correctly for a defender' do
    player = Player.create(name: 'Test Defender', role: 'defender', team:)
  ...
  it 'calculates rating correctly for a goalkeeper' do
    player = Player.create(name: 'Test Goalkeeper', role: 'goalkeeper', team:)
